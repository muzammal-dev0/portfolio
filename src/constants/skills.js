...
export const backendSkills = [
  {
    ...
    title: "Node.js",
    description:
      "Backend development with Node.js, Express, and various databases.",
...
export const devOpsSkills = [
  ...
  {
    icon: "fab fa-aws",
    iconUrl: "https://cdn.simpleicons.org/amazonec2/FF9900",
    title: "EC2",
    description:
  ...
  {
    icon: "fab fa-aws",
    iconUrl: "https://cdn.simpleicons.org/amazons3/569A31",
    title: "S3",
    description:
