    ...
    <section id="home" className="relative py-20 text-white overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
          ...
          <h2 className="text-2xl md:text-3xl mb-8">{personalInfo.title}</h2>
          <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
            <ShinyButton
              onClick={(e) => handleNavClick(e, "contact")}
              className="bg-white text-blue-600 hover:bg-gray-100 font-semibold border border-white"
            >
              Contact Me
            </ShinyButton>
            <ShinyButton
              onClick={(e) => handleNavClick(e, "projects")}
              className="bg-transparent text-white border border-white hover:bg-white/10 font-semibold"
            >
              View My Work
            </ShinyButton>
          </div>
